...
export default function SectionHeader() {
    ...
    return (
        <header id='header' className='h-20 w-full flex items-center justify-end mobile:px-4 border bg-neutral-color-silver-chalice-50 shadow-lg fixed z-50'>
            <div className='w-full flex flex-row mobile:justify-center justify-between'>
                {visualizingNetworks && (
                    <div className='flex flex-row gap-4 text-2x1 text-neutral-color-silver-chalice-900'>
                ...
                <nav className='flex mobile:justify-center mobile:items-center justify-end items-end z-50'>
                    <ul className='flex flex-row gap-8 justify-end mobile:justify-center mobile:items-center text-text-color-masala-500 mobile:text-sm'>
